...
const UserUrls = () => {
    ...
    return (
        <div className="space-y-4 mt-4">
            {urls.map((item) => {
                const fullShortUrl = formatShortUrl(item.short_url || item.shortUrl || item.slug || item.customSlug || '')
                            ...
                            <div className="min-w-0 space-y-3">
                                ...
                                <div className="space-y-2">
                                    <div className="flex flex-wrap items-center gap-2 text-sm text-(--muted)">
                                        ...
                                        <a href={fullShortUrl} target="_blank" rel="noreferrer" className="text-(--accent-strong) hover:text-(--accent) hover:underline truncate">
                                            {fullShortUrl}
                                        </a>
                                    </div>
                                    <div className="flex flex-wrap items-center gap-2 text-sm text-(--muted)">
